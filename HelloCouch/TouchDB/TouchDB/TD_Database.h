...
@class FMDatabase, TD_View, TDBlobStore,TD_Database;
...
// REFACTOR-01
/** NSNotification posted when a database is about to begin new transaction */
extern NSString* const TD_DatabaseBeginTransactionNotification;

/** NSNotification posted when a database is about to rollback transaction */
extern NSString* const TD_DatabaseRollbackTransactionNotification;

/** NSNotification posted when a database is about to commit transaction */
extern NSString* const TD_DatabaseCommitTransactionNotification;

/** NSNotification posted when a database failed to end transaction */
extern NSString* const TD_DatabaseTransactionFailedNotification;
...
// REFACTOR-01
@protocol TD_DatabaseDelegate
@optional
- (void)database:(TD_Database *)database beginTransaction:(NSInteger)txLevel;
- (void)database:(TD_Database *)database commitTransaction:(NSInteger)txLevel;
- (void)database:(TD_Database *)database rollbackTransaction:(NSInteger)txLevel;
- (void)database:(TD_Database *)database endTransactionFailed:(NSInteger)txLevel;
- (void)database:(TD_Database *)database didChange:(NSDictionary *)change;
@end
...
// REFACTOR-01
@property (nonatomic,assign) id<TD_DatabaseDelegate> delegate;
@property (nonatomic) BOOL notifyDelegateOnNestedTransactionEvents;
...
@interface TD_Database (PrivateDelegate)
